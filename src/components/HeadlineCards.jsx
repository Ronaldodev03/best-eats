    ...
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="group relative rounded-xl overflow-hidden">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <button
            className="  border-white bg-white text-black mx-2 absolute bottom-4 rounded-full"
        ...
        <img
          className="max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl group-hover:scale-110 transition-transform duration-300 relative -z-10"
